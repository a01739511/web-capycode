(function () {
    ...
    function buildUsernameDialog(profile) {
        return [
            ...
            "<p class=\"profile-dialog-copy\">Usa un nombre único de entre " + api.USERNAME_MIN_LENGTH + " y " + api.USERNAME_MAX_LENGTH + " caracteres.</p>",
    ...
    function buildPasswordDialog() {
        return [
            ...
            "<p class=\"profile-dialog-copy\">Confirma tu contraseña actual y escribe una nueva de entre " + api.PASSWORD_MIN_LENGTH + " y " + api.PASSWORD_MAX_LENGTH + " caracteres.</p>",
